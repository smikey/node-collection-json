  ...
  _createClass(Link, [{
    ...
    value: function follow() {
      return new Promise(function (resolve, reject) {
        _axios2.default.get(resource).then(function (response) {
          return resolve(_Collection2.default.getByObject(response.data));
        }).catch(function (error) {
          return reject(_Collection2.default.getByObject(error.response.data));
        });
      });
    }
